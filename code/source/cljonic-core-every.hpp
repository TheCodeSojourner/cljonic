...
int main()
{
    ...
    const auto b6{Every(Less10, Repeat<0, int>{10})};  // true when empty Repeat
    const auto b7{Every(Less10, Repeat<10, int>{10})}; // false
    const auto b8{Every(Less10, Repeat<4, int>{1})};   // true
