...
SCENARIO("DefaultElement", "[CljonicCoreDefaultElement]")
{
    ...
    CHECK_CLJONIC(0 == a.DefaultElement());

    constexpr auto rng{Range<1, 5>{}};
    CHECK_CLJONIC(0 == rng.DefaultElement());

    constexpr auto rpt{Repeat<3, int>{11}};
    CHECK_CLJONIC(0 == rpt.DefaultElement());

    constexpr auto set{Set{1, 2, 1, 3, 4}};
    CHECK_CLJONIC(0 == set.DefaultElement());

    constexpr auto str{String{"Hello"}};
    CHECK_CLJONIC('\0' == str.DefaultElement());
