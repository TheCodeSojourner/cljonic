...
*BIG* language that is constantly evolving, with a large and growing set of features. It offers many ways to do things, 
some of which can make it easy to do things poorly.
...
*easy to learn and understand* and *easy to use properly* for the *safe* implementation of embedded systems.
