...
IMPORTANT: I am *NOT* a *Modern {cpp}* expert, and I am *ONLY* moderately competent in *Clojure*. If you have suggestions for improvement, *PLEASE* feel free to create issues, and I'll *do my best* to address them.
...
NOTE: Adding files to the *code/source* or *code/test* directories will require the developer to re-execute `make all`.

NOTE: Adding files to the *code/source* directory will require the developer to update the *scripts/make-cljonic.sh* file.
